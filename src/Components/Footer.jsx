            ...
            <div className="FooterContainer">
                ...
                <div className="FooterLinkContainer">
                    <div className="FooterLink">
                        ...
                        <div className="link"><Link to="/aboutus" spy={true} smooth={true} className="defaultLink">About us</Link></div>   <div className="link"><Link to="/privacy" spy={true} smooth={true} className="defaultLink">Privacy policy</Link></div>
